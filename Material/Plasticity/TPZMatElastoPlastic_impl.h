...
//     }
//
//     TPZTensor<REAL> epst = Memory.m_elastoplastic_state.EpsT();
//   switch (var) {
//       case EDisplacement:
//         {
//             for (int i = 0; i < 3; i++) {
...
//
//     default:
//         std::cout<<"Solution da variável <<"<<var << " nao implementado "<<"\n";
//       DebugStop();
//       break;
//   }
// //     Solout.Resize(this->NSolutionVariables(var));
...
//         Dep.Zero();
//         auto m = this->WithMem();
//         const int gp = data.intGlobPtIndex;
