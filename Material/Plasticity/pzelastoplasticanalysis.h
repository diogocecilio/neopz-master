...
public:
    ...
    virtual bool IterativeProcess(std::ostream &out, REAL tol, int numiter, int niter_update_jac, bool linesearch);
	...
	virtual void IterativeProcess(std::ostream &out,REAL tol,int numiter, bool linesearch, bool checkconv,bool &ConvOrDiverg);
    	...
    	virtual bool IterativeProcess2(std::ostream &out,REAL tol,int numiter, bool linesearch, bool checkconv);
