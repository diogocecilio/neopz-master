...
//            PrintGMeshVTK( gmesh, filemesh2);
			...
			//TPZCompMesh *cmesh = CreateCompMesh2d(*gmesh, porder, prefine);
           ...
           analysis.SetExact(*SolExata);
			...
			analysis.DefineGraphMesh(2, scalnames, vecnames, buf);
