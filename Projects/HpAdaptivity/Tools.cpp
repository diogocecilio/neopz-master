...
void Forcing1(const TPZVec<REAL> &pt, TPZVec<STATE> &disp, TPZFMatrix<STATE> &flux) {
    REAL x = pt[0];
    REAL y = pt[1];
...
TPZCompMesh *CompMeshPAdap(TPZGeoMesh &gmesh,int porder,bool prefine){
	...
	//TPZFunction<STATE>  *dum = new TPZDummyFunction<STATE>(Forcing1);
