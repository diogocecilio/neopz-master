...
//      TPZMatElastoPlasticSest2D<TPZElasticCriteria>  *elasticMat = new TPZMatElastoPlasticSest2D< TPZElasticCriteria >(materialidring,planestrain);
        ...
        TPZMaterial *plastic(PlasticSD);
        //TPZMaterial *elastic(elasticMat);
